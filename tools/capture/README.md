...
| `TMC_NO_CUTSCENE_WATCHDOG=1` | disable the #93 replacement sequence in `sub_08053BBC`, so the original failure can be seen instead of the rescue. The A/B that showed the watchdog converts #93's visible hang into B43's black screen |
