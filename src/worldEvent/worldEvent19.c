...
const EntityData gUnk_080FEED4[] = {
    { NPC, 79, BIG_GORON, 0, 0, 0x140, 0xf8, PORT_ROM_PTR(&script_BigGoronKinstone1) },
    { NPC, 79, BIG_GORON, 5, 0, 0xd0, 0xc8, PORT_ROM_PTR(&script_BigGoronKinstone2) },
    { NPC, 79, BIG_GORON, 10, 0, 0x1b0, 0x108, PORT_ROM_PTR(&script_BigGoronKinstone3) },
